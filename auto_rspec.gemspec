...
require_relative "lib/auto_rspec/version"

Gem::Specification.new do |spec|
  spec.name = "auto_rspec"
  spec.version = "0.1.0"
  spec.authors = ["Ivan_Bastylo"]
  spec.email = ["b15042002@gmail.com"]
  ...
  spec.add_dependency 'shoulda-matchers', '~> 5.0'
